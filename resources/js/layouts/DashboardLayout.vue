          ...
          <div class="relative pl-4 border-l border-zinc-200">
            ...
            <transition name="dropdown">
              <div v-if="isUserMenuOpen" class="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-xl py-2 border border-zinc-100/80 z-50 origin-top-right">
                ...
                <router-link to="/painel/users" @click="isUserMenuOpen = false" class="flex items-center space-x-2 px-4 py-2.5 text-sm text-zinc-700 hover:bg-zinc-50 hover:text-indigo-600 transition-colors">
...
const menuGroups: MenuGroup[] = [
  {
    ...
    showTitle: false,
    items: [
      { name: 'Dashboard', to: '/painel', icon: DashboardIcon },
    ]
  },
  {
    name: 'Recursos',
