  ...
  <div class="space-y-6">
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-zinc-100 p-8 shadow-inner overflow-hidden relative">
      ...
      <div class="flex items-center justify-between mb-8 relative z-10">
        ...
        <router-link to="/painel/atividades" class="text-sm font-semibold text-indigo-600 hover:text-indigo-700 bg-indigo-50 px-4 py-2 rounded-lg transition-colors inline-block">
          Ver todas
        </router-link>
      </div>
